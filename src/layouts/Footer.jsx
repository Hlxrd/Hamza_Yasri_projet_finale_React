                ...
                <div className="mx-auto w-[100%] py-7 max-w-7xl  ">
                    <div className="grid grid-cols-1 justify-between md:grid-cols-2 ">
                        <Typography variant="h5" className="mb-6 p-2 flex flex-col justify-between items-start">
                            ...
                            <div className='flex flex-col justify-start items-start h-[20%]'><p className='text-sm'>Any questions? Let us know  on (+212) 65720****</p>
                                <div className="flex gap-4 text-blue-gray-900 pt-4 sm:justify-center items-start">
                        ...
                        <div className="grid grid-cols-3 justify-between flex flex-col lg:flex-row gap-4 ">
                            {LINKS.map(({ title, items }) => (
                                <ul key={title} className=''>
                                    <Typography
                                        variant="small"
                                        color="blue-gray"
                                        className="mb-3 font-medium opacity-40 text-xl text-gray-900"
                                    >
                                        {title}
                                    </Typography>
                                    {items.map((link) => (
                    ...
                    <div className="mt-12 flex w-full flex-col items-center  justify-center border-t  py-4 md:flex-row md:justify-between">
                        ...
                        >
                            &copy; {currentYear} <a href="">Material Tailwind</a>. All
                            Rights Reserved.
                        </Typography>
